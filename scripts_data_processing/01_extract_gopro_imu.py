"""
Acknowledgement:
This script was obtained from the Universal Manipulation Interface (UMI) project repository:
https://github.com/real-stanford/universal_manipulation_interface.git
"""
# %%
import sys
import os
